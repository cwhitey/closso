...
var temp__4124__auto__ = (function (){var or__12610__auto__ = cljs.core.re_find.call(null,/[.\\/\-\s].*?/,fmt);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [separator,(function (){var pred__17571 = cljs.core._EQ_;
var expr__17572 = separator;
if(cljs.core.truth_(pred__17571.call(null,".",expr__17572))){
return /\./;
} else {
if(cljs.core.truth_(pred__17571.call(null," ",expr__17572))){
return /W+/;
...
var fmt__$1 = (function (){var or__12610__auto__ = fmt;
if(cljs.core.truth_(or__12610__auto__)){
return or__12610__auto__;
} else {
return "mm/dd/yyyy";
...
var vec__17575 = reagent_forms.datepicker.separator_matcher.call(null,fmt__$1);
var separator = cljs.core.nth.call(null,vec__17575,(0),null);
var matcher = cljs.core.nth.call(null,vec__17575,(1),null);
...
var G__17577 = (new Date());
G__17577.setHours((0));

G__17577.setMinutes((0));

G__17577.setSeconds((0));

G__17577.setMilliseconds((0));
...
reagent_forms.datepicker.format_date = (function format_date(p__17595,p__17596){
var map__17599 = p__17595;
...
var day = cljs.core.get.call(null,map__17599__$1,new cljs.core.Keyword(null,"day","day",-274800446));
var month = cljs.core.get.call(null,map__17599__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var year = cljs.core.get.call(null,map__17599__$1,new cljs.core.Keyword(null,"year","year",335913393));
var map__17600 = p__17596;
...
var parts = cljs.core.get.call(null,map__17600__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var separator = cljs.core.get.call(null,map__17600__$1,new cljs.core.Keyword(null,"separator","separator",-1628749125));
return clojure.string.join.call(null,separator,cljs.core.map.call(null,((function (map__17599,map__17599__$1,day,month,year,map__17600,map__17600__$1,parts,separator){
return (function (p1__17594_SHARP_){
if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([p1__17594_SHARP_], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"d","d",1972142424),new cljs.core.Keyword(null,"dd","dd",-1340437629)], null)))){
return reagent_forms.datepicker.formatted_value.call(null,day);
} else {
if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([p1__17594_SHARP_], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"m","m",1632677161),new cljs.core.Keyword(null,"mm","mm",-1652850560)], null)))){
return reagent_forms.datepicker.formatted_value.call(null,month);
} else {
if(cljs.core._EQ_.call(null,p1__17594_SHARP_,new cljs.core.Keyword(null,"yy","yy",-1432012814))){
return [cljs.core.str(year)].join('').substring((2));
} else {
if(cljs.core._EQ_.call(null,p1__17594_SHARP_,new cljs.core.Keyword(null,"yyyy","yyyy",2098225339))){
return year;
} else {
return null;
}
...
});})(map__17599,map__17599__$1,day,month,year,map__17600,map__17600__$1,parts,separator))
,parts));
});
reagent_forms.datepicker.first_day_of_week = (function first_day_of_week(year,month){
return (function (){var G__17602 = (new Date());
G__17602.setYear(year);

G__17602.setMonth(month);
...
reagent_forms.datepicker.gen_days = (function gen_days(p__17603,get,save_BANG_){
var vec__17609 = p__17603;
var year = cljs.core.nth.call(null,vec__17609,(0),null);
var month = cljs.core.nth.call(null,vec__17609,(1),null);
...
return cljs.core.map.call(null,((function (num_days,last_month_days,first_day,vec__17609,year,month){
...
});})(num_days,last_month_days,first_day,vec__17609,year,month))
,cljs.core.partition.call(null,(7),(function (){var iter__13366__auto__ = ((function (num_days,last_month_days,first_day,vec__17609,year,month){
return (function iter__17610(s__17611){
return (new cljs.core.LazySeq(null,((function (num_days,last_month_days,first_day,vec__17609,year,month){
return (function (){
...
var c__13364__auto__ = cljs.core.chunk_first.call(null,s__17611__$2);
var size__13365__auto__ = cljs.core.count.call(null,c__13364__auto__);
var b__17613 = cljs.core.chunk_buffer.call(null,size__13365__auto__);
if((function (){var i__17612 = (0);
while(true){
if((i__17612 < size__13365__auto__)){
var i = cljs.core._nth.call(null,c__13364__auto__,i__17612);
cljs.core.chunk_append.call(null,b__17613,(((i < first_day))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.old","td.day.old",1008935029),(cljs.core.truth_(last_month_days)?(last_month_days - ((first_day - i) - (1))):null)], null):(((i < (first_day + num_days)))?(function (){var day = ((i - first_day) + (1));
...
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__17612,day,date,i,c__13364__auto__,size__13365__auto__,b__17613,s__17611__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__17609,year,month){
return (function (){
...
});})(i__17612,day,date,i,c__13364__auto__,size__13365__auto__,b__17613,s__17611__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__17609,year,month))
], null),day], null);
...
var i = cljs.core.first.call(null,s__17611__$2);
...
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (day,date,i,s__17611__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__17609,year,month){
return (function (){
if(cljs.core._EQ_.call(null,get.call(null),date)){
return save_BANG_.call(null,null);
} else {
...
});})(day,date,i,s__17611__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__17609,year,month))
], null),day], null);
})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.new","td.day.new",500967295),(((month < (11)))?((i - (first_day + num_days)) + (1)):null)], null)
)),iter__17610.call(null,cljs.core.rest.call(null,s__17611__$2)));
}
} else {
return null;
}
...
;
return iter__13366__auto__.call(null,cljs.core.range.call(null,(42)));
})()));
});
reagent_forms.datepicker.last_date = (function last_date(p__17615){
var vec__17617 = p__17615;
var year = cljs.core.nth.call(null,vec__17617,(0),null);
var month = cljs.core.nth.call(null,vec__17617,(1),null);
if((month > (0))){
...
reagent_forms.datepicker.next_date = (function next_date(p__17618){
var vec__17620 = p__17618;
var year = cljs.core.nth.call(null,vec__17620,(0),null);
var month = cljs.core.nth.call(null,vec__17620,(1),null);
