...
var or__12610__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__15981 = res;
(G__15981[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__15982){
var vec__15984 = p__15982;
var id = cljs.core.nth.call(null,vec__15984,(0),null);
var class$ = cljs.core.nth.call(null,vec__15984,(1),null);
var pid = (props["id"]);
...
var pname_15985 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_15985 === "key"))){
(o[pname_15985] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__15988 = jsprops;
(G__15988["defaultValue"] = value);

(G__15988["value"] = null);

(G__15988["onChange"] = ((function (G__15988,on_change,value){
return (function (p1__15986_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15986_SHARP_);
});})(G__15988,on_change,value))
);
...
var G__15990 = spec;
(G__15990["componentDidUpdate"] = ((function (G__15990){
return (function (){
var C = this;
...
(G__15990["componentWillUnmount"] = ((function (G__15990){
return (function (){
var C = this;
...
var spec = {"displayName": (function (){var or__12610__auto__ = name;
if(cljs.core.truth_(or__12610__auto__)){
return or__12610__auto__;
} else {
...
return (function (p1__15991_SHARP_,p2__15992_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__15991_SHARP_,p2__15992_SHARP_);
...
var vec__15994 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15994,(0),null);
var id = cljs.core.nth.call(null,vec__15994,(1),null);
var class$ = cljs.core.nth.call(null,vec__15994,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__12610__auto__ = id;
if(cljs.core.truth_(or__12610__auto__)){
return or__12610__auto__;
} else {
...
var vec__15996 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__15996,(0),null);
var id_class = cljs.core.nth.call(null,vec__15996,(1),null);
...
var jsprops = (function (){var obj16000 = {};
(obj16000[reagent.impl.util.cljs_argv] = v);

(obj16000[reagent.impl.util.cljs_level] = level);

return obj16000;
})();
var k_16001 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__16002 = (((k_16001 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_16001);
if((k_SINGLEQUOTE__16002 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__16002);
}
...
var n__13497__auto___16003 = a.length;
var i_16004 = (0);
while(true){
if((i_16004 < n__13497__auto___16003)){
(a[i_16004] = reagent.impl.template.as_component.call(null,(a[i_16004]),level_SINGLEQUOTE_));

var G__16005 = (i_16004 + (1));
i_16004 = G__16005;
continue;
} else {
}
...
var n__13497__auto___16006 = a.length;
var i_16007 = (0);
while(true){
if((i_16007 < n__13497__auto___16006)){
if((i_16007 >= first_child)){
(a[i_16007] = reagent.impl.template.as_component.call(null,(a[i_16007]),level));
} else {
}

var G__16008 = (i_16007 + (1));
i_16007 = G__16008;
continue;
} else {
}
