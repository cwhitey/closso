...
var or__12610__auto__ = w.requestAnimationFrame;
if(cljs.core.truth_(or__12610__auto__)){
return or__12610__auto__;
} else {
var or__12610__auto____$1 = w.webkitRequestAnimationFrame;
if(cljs.core.truth_(or__12610__auto____$1)){
return or__12610__auto____$1;
} else {
var or__12610__auto____$2 = w.mozRequestAnimationFrame;
if(cljs.core.truth_(or__12610__auto____$2)){
return or__12610__auto____$2;
} else {
var or__12610__auto____$3 = w.msRequestAnimationFrame;
...
var n__13497__auto__ = a.length;
var i = (0);
while(true){
if((i < n__13497__auto__)){
var C_15975 = (a[i]);
if(cljs.core.truth_(C_15975.cljsIsDirty)){
C_15975.forceUpdate();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__13197__auto__,writer__13198__auto__,opt__13199__auto__){
return cljs.core._write.call(null,writer__13198__auto__,"reagent.impl.batching/RenderQueue");
});
...
var and__12598__auto__ = !((C == null));
if(and__12598__auto__){
var and__12598__auto____$1 = (C["props"]);
...
var ratom_15977 = C.cljsRatom;
if(!((ratom_15977 == null))){
reagent.ratom.dispose_BANG_.call(null,ratom_15977);
} else {
}
