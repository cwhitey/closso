...
{return (function() { 
var G__6730__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__6733 = res;(G__6733[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__6733;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6734){var vec__6736 = p__6734;var id = cljs.core.nth.call(null,vec__6736,(0),null);var class$ = cljs.core.nth.call(null,vec__6736,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_6737 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_6737 === "key")))
{(o[pname_6737] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__6740 = jsprops;(G__6740["defaultValue"] = value);
(G__6740["value"] = null);
(G__6740["onChange"] = ((function (G__6740,on_change,value){
return (function (p1__6738_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6738_SHARP_);
});})(G__6740,on_change,value))
);
return G__6740;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__6742 = spec;(G__6742["componentDidUpdate"] = ((function (G__6742){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__6742))
);
(G__6742["componentWillUnmount"] = ((function (G__6742){
...
return (function (p1__6743_SHARP_,p2__6744_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__6743_SHARP_,p2__6744_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__6746 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__6746,(0),null);var id = cljs.core.nth.call(null,vec__6746,(1),null);var class$ = cljs.core.nth.call(null,vec__6746,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__6748 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__6748,(0),null);var id_class = cljs.core.nth.call(null,vec__6748,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj6752 = {};(obj6752[reagent.impl.util.cljs_argv] = v);
(obj6752[reagent.impl.util.cljs_level] = level);
return obj6752;
})();var k_6753 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__6754 = (((k_6753 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_6753);if((k_SINGLEQUOTE__6754 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__6754);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4510__auto___6755 = a.length;var i_6756 = (0);while(true){
if((i_6756 < n__4510__auto___6755))
{(a[i_6756] = reagent.impl.template.as_component.call(null,(a[i_6756]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4510__auto___6758 = a.length;var i_6759 = (0);while(true){
if((i_6759 < n__4510__auto___6758))
{if((i_6759 >= first_child))
{(a[i_6759] = reagent.impl.template.as_component.call(null,(a[i_6759]),level));
} else
{}
{
var G__6760 = (i_6759 + (1));
i_6759 = G__6760;
continue;
}
} else
