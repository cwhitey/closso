...
{var C_6727 = (a[i]);if(cljs.core.truth_(C_6727.cljsIsDirty))
{C_6727.forceUpdate();
} else
{}
{
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__3628__auto__ = !((C == null));if(and__3628__auto__)
{var and__3628__auto____$1 = (C["props"]);if(cljs.core.truth_(and__3628__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_6729 = C.cljsRatom;if(!((ratom_6729 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_6729);
} else
{}
