...
var G__6708__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__6708 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__6708__delegate.call(this,x,rest);};
G__6708.cljs$lang$maxFixedArity = 1;
G__6708.cljs$lang$applyTo = (function (arglist__6709){
var x = cljs.core.first(arglist__6709);
var rest = cljs.core.rest(arglist__6709);
return G__6708__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__6710){
var f = cljs.core.first(arglist__6710);
var args = cljs.core.rest(arglist__6710);
