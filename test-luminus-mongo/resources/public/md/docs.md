<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>test-luminus-mongo.db.core</code> namespace.
...
Request middleware functions are located under the `test-luminus-mongo.middleware` namespace.
