(ns test-web.view.auth
    (:require [ring.util.response :as response]
              [compojure.core :refer [defroutes GET POST]]
              [stencil.core :as stencil]
              [test-web.util.session :as session]
              [test-web.util.flash :as flash]
              [test-web.service.db :as db]
              [test-web.view.common :refer [wrap-context-root wrap-layout authenticated?]]))
...
(defn- signup-page
  ...
  (wrap-layout
   "Sign up"
   (stencil/render-file
    "test_web/view/templates/signup"
    {})))
...
(defn- reset-pass-page
  ...
  (wrap-layout
   "Reset password"
   (stencil/render-file
    "test_web/view/templates/reset-pass"
    {})))
