(ns ^:shared pedestal-test-app.behavior
    (:require [clojure.string :as string]
              [io.pedestal.app.messages :as msg]))
;; While creating new behavior, write tests to confirm that it is
;; correct. For examples of various kinds of tests, see
;; test/pedestal_test_app/behavior-test.clj.
...
;;
;; app/templates/pedestal-test-app.html
;;
;; slicing the template into pieces you can use:
;;
;; app/src/pedestal_test_app/html_templates.cljs
;;
